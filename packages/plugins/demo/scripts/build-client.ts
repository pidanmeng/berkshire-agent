...
await $`bun build ${entry} --outdir ${outdir} --target=browser --format=esm --external react --external react/jsx-runtime --external react/jsx-dev-runtime --external @berkshire/ui-slots --external @berkshire/theme`;