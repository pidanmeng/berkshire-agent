...
│       └── src/             #   webview: main.tsx, App.tsx + slots/（webview 本地 slot 宿主已落地，T0）；router/store/client-plugins 为计划
