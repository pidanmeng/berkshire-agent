...
│       └── src/             #   webview: main.tsx, App.tsx + slots/（webview 本地 slot 宿主+反应式订阅，已落地） + client/（ClientModuleHost/loader/demo，T1 client 插件图最小链路）；router/store/client-plugins 为计划
