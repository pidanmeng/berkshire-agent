...
│       └── src/             #   webview: main.tsx, App.tsx + slots/（webview 本地 slot 宿主+反应式订阅，T0）+ client/（ClientModuleHost/loader/demo，T1 链路）+ menu/（HashRouter 核心路由 + analysis.menu 动态导航/路由，T2）；store/client-plugins 为计划
